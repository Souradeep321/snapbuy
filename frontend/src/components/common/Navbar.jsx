    ...
    >
      <div className="max-w-7xl lg:h-[10vh] mx-auto px-2 py-3 flex justify-between items-center">
            ...
            <SheetContent side="left" className="w-[260px] px-4 py-6 flex flex-col gap-6">
              ...
              <nav className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <NavLink to="/about" className="text-sm font-medium hover:text-black">
                    About
                  </NavLink>
                  <NavLink to="/contact" className="text-sm font-medium hover:text-black">
                    Contact
                  </NavLink>
                </div>
              </nav>
        ...
        <span
          ...
          onClick={() => navigate('/')}
        >
          <NavLink to="/" className="text-xl font-serif tracking-widest text-zinc-800">
            Snapbuy
          </NavLink>
        ...
        <div className="hidden md:flex gap-6 text-sm font-medium items-center">
          ...
          <NavLink to="/about" className="px-2 py-1 text-gray-700 hover:text-black">
            About
          </NavLink>
          <NavLink to="/contact" className="px-2 py-1 text-gray-700 hover:text-black">
            Contact
          </NavLink>
        </div>
